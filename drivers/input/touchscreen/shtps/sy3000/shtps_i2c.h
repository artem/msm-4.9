/* drivers/input/touchscreen/shtps/sy3000/shtps_i2c.h
 *
...
#define M_FIRMWARE_WRITE_FUNC(A, B, C, D)	(A)->devctrl_func_p->packet_write_f((A)->tps_ctrl_p, B, C, D)
#define M_WRITE_BLOCK_FUNC(A, B, C, D)		(A)->devctrl_func_p->packet_write_f((A)->tps_ctrl_p, B, C, D)
#define M_READ_BLOCK_FUNC(A, B, C, D, E)	(A)->devctrl_func_p->packet_read_f((A)->tps_ctrl_p, B, C, D, E)
