...
// [COM5] Step Counter
// [COM5] Step Detector
// [COM5] Device orientation    /* SHMDS_HUB_0132_01 add */
...
#define SHUB_GPIO_RST     (59)  /* SHMDS_HUB_0121_01 SHMDS_HUB_0133_02 mod (93->39->73->59) */
#define SHUB_GPIO_REMP    (61)  /* SHMDS_HUB_0121_01 SHMDS_HUB_0127_01 SHMDS_HUB_0133_02 mod (94->86->96->44->61) */
#define SHUB_GPIO_INT0   (122)  /* SHMDS_HUB_0121_01 SHMDS_HUB_0133_02 mod (75->44->69->122) */
/* SHMDS_HUB_0115_01 mod S */
#ifdef SHUB_SW_GPIO_INT1
...
static int shub_com_get_input_no(int inp_type)
{
    ...
    case SHUB_INPUT_DEVICE_ORI:  // [COM5] Device orientation   /* SHMDS_HUB_0132_01 add */
...
/* SHMDS_HUB_0132_01 add S */
        // Device orientation
        input_set_abs_params(shub_idev[no], ABS_Y, 0, 2, 0, 0);
        input_set_abs_params(shub_idev[no], ABS_RX, 0, 2, 0, 0);
        input_set_abs_params(shub_idev[no], ABS_RY, 0, 0xFFFFFFFF, 0, 0);
        input_set_abs_params(shub_idev[no], ABS_RZ, 0, 0xFFFFFFFF, 0, 0);
