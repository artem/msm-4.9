/* drivers/input/touchscreen/shtps/sy3000/shtps_fwctl_s3400.c
 *
...
static int shtps_fwctl_s3400_loader_cmd_get_partition_table(struct shtps_fwctl_info *fc_p);
static int shtps_fwctl_s3400_loader_get_partition_table(struct shtps_fwctl_info *fc_p);
...
static int shtps_fwctl_s3400_loader_cmd_erase_config(struct shtps_fwctl_info *fc_p);
...
static int shtps_fwctl_s3400_check_crc_error(struct shtps_fwctl_info *fc_p, u8 *status_p);
...
static int shtps_fwctl_s3400_get_pageselect(struct shtps_fwctl_info *fc_p, u8 *buf);
...
/* -------------------------------------------------------------------------- */
static int shtps_fwctl_s3400_get_tm_moisture(struct shtps_fwctl_info *fc_p, u8 tm_mode, u8 *tm_data_p)
{
	int i, j;
	u8  tmp[SHTPS_TM_TXNUM_MAX * 2];
	int index = 0;
...
/* -------------------------------------------------------------------------- */
static int shtps_fwctl_s3400_get_tm_moisture_no_mask(struct shtps_fwctl_info *fc_p, u8 tm_mode, u8 *tm_data_p)
{
	return shtps_fwctl_s3400_get_tm_moisture(fc_p, tm_mode, tm_data_p);
}
...
/* -------------------------------------------------------------------------- */
static int shtps_fwctl_s3400_cmd_tm_moisture(struct shtps_fwctl_info *fc_p, u8 tm_mode)
{
	int rc;
	SHTPS_LOG_FWCTL_FUNC_CALL();
...
/* -------------------------------------------------------------------------- */
static int shtps_fwctl_s3400_cmd_tm_moisture_no_mask(struct shtps_fwctl_info *fc_p, u8 tm_mode)
{
	int rc;
	int i;
...
static int shtps_fwctl_s3400_baseline_offset_disable(struct shtps_fwctl_info *fc_p)
{
	...
	rc = M_WRITE_FUNC(fc_p, fc_p->map_p->fn54.ctrlBase + SHTPS_REG_F54_ANALOG_CTRL41_OFFSET, 0x01);
	if(rc != 0)	goto err_exit;
...
/* -------------------------------------------------------------------------- */
static int shtps_fwctl_s3400_cover_set_report_num_max(struct shtps_fwctl_info *fc_p)
{
	int rc = 0;
	...
	SHTPS_LOG_FWCTL_FUNC_CALL();
		...
		rc = M_WRITE_FUNC(fc_p,
						  fc_p->map_p->fn51.ctrlBase + F51_QUERY_COVERMODEREGISTERADDRESS(fc_p->map_p->fn51.query.data) + 17,
						  SHTPS_REG_PRM_COVER_REPORT_NUM_MAX);
...
/* -------------------------------------------------------------------------- */
static int shtps_fwctl_s3400_cover_set_finger_amplitude_threshold(struct shtps_fwctl_info *fc_p, u8 param)
{
	int rc = 0;
	...
	SHTPS_LOG_FWCTL_FUNC_CALL();
		...
		rc = M_WRITE_FUNC(fc_p,
						  fc_p->map_p->fn51.ctrlBase + F51_QUERY_COVERMODEREGISTERADDRESS(fc_p->map_p->fn51.query.data) + 12,
						  param);
...
/* -------------------------------------------------------------------------- */
static int shtps_fwctl_s3400_get_productid(struct shtps_fwctl_info *fc_p, u8 *buf_p)
{
	char productID[11];
	int rc = 0;
...
/* -------------------------------------------------------------------------- */
static int shtps_fwctl_s3400_update_max_position(struct shtps_fwctl_info *fc_p, int x, int y)
{
	int rc = 0;
	u8 maxPosition[4];
...
/* -------------------------------------------------------------------------- */
static int shtps_fwctl_s3400_get_interrupt_enable(struct shtps_fwctl_info *fc_p, u8 *buf_p)
{
	SHTPS_LOG_FWCTL_FUNC_CALL();
...
struct shtps_fwctl_functbl		shtps_fwctl_s3400_function_table = {
		...
		.loader_cmd_get_partition_table_f			= shtps_fwctl_s3400_loader_cmd_get_partition_table,
		.loader_get_partition_table_f				= shtps_fwctl_s3400_loader_get_partition_table,
		...
		.loader_cmd_erase_config_f					= shtps_fwctl_s3400_loader_cmd_erase_config,
		...
		.check_crc_error_f							= shtps_fwctl_s3400_check_crc_error,
		...
		.get_pageselect_f							= shtps_fwctl_s3400_get_pageselect,
		...
		.get_tm_moisture_f							= shtps_fwctl_s3400_get_tm_moisture,
		.get_tm_moisture_no_mask_f					= shtps_fwctl_s3400_get_tm_moisture_no_mask,
		...
		.cmd_tm_moisture_f							= shtps_fwctl_s3400_cmd_tm_moisture,
		.cmd_tm_moisture_no_mask_f					= shtps_fwctl_s3400_cmd_tm_moisture_no_mask,
		...
		.cover_set_report_num_max_f					= shtps_fwctl_s3400_cover_set_report_num_max,
		.cover_set_finger_amplitude_threshold_f		= shtps_fwctl_s3400_cover_set_finger_amplitude_threshold,
		...
		.get_productid_f							= shtps_fwctl_s3400_get_productid,
		.update_max_position_f						= shtps_fwctl_s3400_update_max_position,
		.get_interrupt_enable_f						= shtps_fwctl_s3400_get_interrupt_enable,
};
/* -------------------------------------------------------------------------- */
/* -------------------------------------------------------------------------- */
/* -------------------------------------------------------------------------- */
