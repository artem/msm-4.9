...
enum pon_restart_reason {
	...
	PON_RESTART_REASON_EMERGENCY_NODLOAD	= 0x21,
	PON_RESTART_REASON_WHILE_LINUX_RUNNING	= 0x22,
	PON_RESTART_REASON_REBOOT_FROM_SHRLOG_EMERGENCY	= 0x23,
	PON_RESTART_REASON_REBOOT_FROM_SHRLOG_SURFACE	= 0x24,
	PON_RESTART_REASON_REBOOT_FROM_SHRLOG_L1_ERROR	= 0x25,
	PON_RESTART_REASON_REBOOT_FROM_SHRLOG_HW_WTD_MODE	= 0x26,
	PON_RESTART_REASON_REBOOT_FROM_SHRLOG_MODEM_CRASH	= 0x27,
	PON_RESTART_REASON_REBOOT_FROM_SHRLOG_DVDD_HARD	= 0x28,
	PON_RESTART_REASON_REBOOT_FROM_SHDLOAD	= 0x29,    /* LoaderGr Add */
