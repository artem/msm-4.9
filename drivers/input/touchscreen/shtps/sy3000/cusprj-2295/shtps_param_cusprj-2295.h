/* drivers/input/touchscreen/shtps/sy3000/cusprj-2295/shtps_param_cusprj-2295.h
 *
 ...
 *
 */
#ifndef __SHTPS_PARAM_CUSPRJ_2295_H__
#define __SHTPS_PARAM_CUSPRJ_2295_H__
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_CTRL_FW_REPORT_RATE_PARAM_NORMAL,		0x5A);
	SHTPS_PARAM_DEF( SHTPS_CTRL_FW_REPORT_RATE_PARAM_HIGH,			0x78);
 ...
 */
	...
	SHTPS_PARAM_DEF( SHTPS_REG_PRM_COVER_WINDOW_RIGHT, 				1079);
	SHTPS_PARAM_DEF( SHTPS_REG_PRM_COVER_WINDOW_BOTTOM, 			2279);
 ...
 */
		...
		SHTPS_PARAM_DEF( SHTPS_PRM_GLOVE_CHANGE_TUI_ENABLE,		1);
		SHTPS_PARAM_DEF( SHTPS_PRM_GLOVE_CHANGE_TUI_TX,			0x14);
		SHTPS_PARAM_DEF( SHTPS_PRM_GLOVE_CHANGE_TUI_RX,			0x14);
	#endif /* SHTPS_DEF_GLOVE_CHANGE_THERMAL_UPDATE_INTERVAL_ENABLE */
	#if defined(SHTPS_DEF_GLOVE_CHANGE_FREQ_SCAN_THRESHOLD_ENABLE)
		SHTPS_PARAM_DEF( SHTPS_PRM_GLOVE_CHANGE_FST_ENABLE,		1);
		SHTPS_PARAM_DEF( SHTPS_PRM_GLOVE_CHANGE_FST,			0x02AA);
		...
		SHTPS_PARAM_DEF( SHTPS_PRM_GLOVE_DISABLE_MOISTURE_ENABLE,	1);
...
/* -----------------------------------------------------------------------------------
 */
#endif /* __SHTPS_PARAM_CUSPRJ_2295_H__ */
